...
export const TRUE_ERC20 = {
    ...
    [NetworkEnum.ARBITRUM_SEPOLIA]: new Address(
        '0x6abed82c6522ec1781ad57bb5a6c9682cd64acfd'
    ),
...
export const ESCROW_SRC_IMPLEMENTATION = {
    ...
    [NetworkEnum.ARBITRUM_SEPOLIA]: new Address(
        '0xdf72A53658b379205832eA29beACD273Bb38c91a'
    ),
    [NetworkEnum.MONAD]: new Address(
        '0xdf72A53658b379205832eA29beACD273Bb38c91a'
    ),
...
export const ESCROW_DST_IMPLEMENTATION = {
    ...
    [NetworkEnum.ARBITRUM_SEPOLIA]: new Address(
        '0xb5D6A8D096e9DbeD4DD7F1b05f5b0c7F6e831666'
    ),
    [NetworkEnum.MONAD]: new Address(
        '0xb5D6A8D096e9DbeD4DD7F1b05f5b0c7F6e831666'
    ),
...
export const ESCROW_FACTORY = {
    ...
    [NetworkEnum.ARBITRUM_SEPOLIA]: new Address(
        '0x06770B86ABee7B3991f235BE4b6d920862979e13'
    ),
    [NetworkEnum.MONAD]: new Address(
        '0x06770B86ABee7B3991f235BE4b6d920862979e13'
    ),
